...
Alongside my studies, I work on side-projects, including <a href='https://ecrismalettre.fr' target='_blank' class='underline'>ecrismalettre.fr</a>, a cover letter generation service based on a CV and a job offer.`,
  ...
  chess: {
    ...
    playAgainstAI: "Play against Stockfish (local)",
    playP2P: "Play P2P",
    faceStockfish:
      "Face Stockfish (unfortunately, I'm not available right now, but don't worry, Stockfish will take good care of you!)",
    playWithFriend:
      "Against a friend online (why use chess.com when you can play here?)",
    p2pMode: "P2P Mode",
    createOrJoin: "Create or join a game",
    createGame: "Create a game",
    generateCode: "Generate a code to share",
    or: "or",
    ...
    checkOpponentTurn: "Check! Opponent's turn",
    roomCreated: "Room created! Share the Room ID",
    roomIdCopied: "Room ID copied!",
    enterRoomIdError: "Please enter a Room ID",
    connectionError: "Error connecting to the room",
